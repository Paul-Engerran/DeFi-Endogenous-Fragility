...
evidence to the conditional tails; and, net of volatility, we can
\emph{exclude} downside-specific amplification larger than roughly
\MdeEightyExc{} per unit of the log-liquidation shock, at the one-percent tail. That is evidence of
absence at the economically relevant scale, not a bare failure to reject. A
faint one-percent whisper survives detection but falls below the smallest
effect size of interest and does not carry the conclusion.
...
Three directions follow. We ran an unconditional-quantile (RIF) cross-check
...
lives, outside our perimeter. The contribution we claim is correspondingly
