...
\label{tab:qlp}
\input{../paper/tables/tab2_qlp_main}
...
a mechanism-specific interaction not detectably different from zero,
imprecisely estimated rather than tightly bounded, with the paper's
decisive, quantified bounds attaching instead to the symmetric-scale and
down-minus-up asymmetry objects (Section~\ref{sec:survives}). The question that the next
